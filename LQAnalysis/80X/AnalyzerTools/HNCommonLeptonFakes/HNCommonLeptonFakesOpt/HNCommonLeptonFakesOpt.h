#ifndef HNCommonLeptonFakesOpt_H
#define HNCommonLeptonFakesOpt_H
...
class HNCommonLeptonFakesOpt {

 public:
  /// Destructor
  ~HNCommonLeptonFakesOpt();

  /// constructor
  HNCommonLeptonFakesOpt(std::string path = "../share/", bool usegev=false);
