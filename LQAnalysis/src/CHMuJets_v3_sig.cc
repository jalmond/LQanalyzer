...
ClassImp (CHMuJets_v3_sig);

/**
 *   This is an Example Cycle. It inherits from AnalyzerCore. The code contains all the base class functions to run the analysis.
 *
 */
CHMuJets_v3_sig::CHMuJets_v3_sig() :  AnalyzerCore(),  out_electrons(0) {

  // To have the correct name in the log:
 
  SetLogName("CHMuJets_v3_sig");
  Message("In CHMuJets_v3_sig constructor", INFO);
  //
...
void CHMuJets_v3_sig::InitialiseAnalysis() throw( LQError ) {
...
void CHMuJets_v3_sig::ExecuteEvents()throw( LQError ){
...
int CHMuJets_v3_sig::ExecuteSystematics(int method, TString label)throw( LQError ){
...
void CHMuJets_v3_sig::EndCycle()throw( LQError ){
  
  Message("In EndCycle" , INFO);
}


void CHMuJets_v3_sig::BeginCycle() throw( LQError ){
...
CHMuJets_v3_sig::~CHMuJets_v3_sig() {
  
  Message("In CHMuJets_v3_sig Destructor" , INFO);
  if(!k_isdata)delete reweightPU;
  if(!k_isdata) delete fBTagSF;
  //	delete minuit;
}
         
void CHMuJets_v3_sig::FillCutFlow(TString label,TString cut, float weight){
...
void CHMuJets_v3_sig::BeginEvent( )throw( LQError ){
...
void CHMuJets_v3_sig::MakeHistograms(TString label){
  ...
  /**
   *  Remove//Overide this CHMuJets_v3_sigCore::MakeHistograms() to make new hists for your analysis
   **/
...
void CHMuJets_v3_sig::ClearOutputVectors() throw(LQError) {
...
void CHMuJets_v3_sig::mysort(std::vector<snu::KJet> jetColl_lepveto, int jet_index[]){
