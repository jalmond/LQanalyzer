...
/// Local includes
#include "CHElJets_v3_sig_jecFlav.h"
...
ClassImp (CHElJets_v3_sig_jecFlav);

/**
 *   This is an Example Cycle. It inherits from AnalyzerCore. The code contains all the base class functions to run the analysis.
 *
 */
CHElJets_v3_sig_jecFlav::CHElJets_v3_sig_jecFlav() :  AnalyzerCore(),  out_electrons(0) {

	// To have the correct name in the log:
 
	SetLogName("CHElJets_v3_sig_jecFlav");
	Message("In CHElJets_v3_sig_jecFlav constructor", INFO);
	//
...
void CHElJets_v3_sig_jecFlav::InitialiseAnalysis() throw( LQError ) {
...
void CHElJets_v3_sig_jecFlav::ExecuteEvents()throw( LQError ){
...
int CHElJets_v3_sig_jecFlav::ExecuteSystematics(int method, TString label)throw( LQError ){
...
void CHElJets_v3_sig_jecFlav::EndCycle()throw( LQError ){
  
	Message("In EndCycle" , INFO);
}


void CHElJets_v3_sig_jecFlav::BeginCycle() throw( LQError ){
...
CHElJets_v3_sig_jecFlav::~CHElJets_v3_sig_jecFlav() {
  
	Message("In CHElJets_v3_sig_jecFlav Destructor" , INFO);
	if(!k_isdata)delete reweightPU;
	if(!k_isdata) delete fBTagSF;
	//	delete minuit;
}
         
void CHElJets_v3_sig_jecFlav::FillCutFlow(TString label,TString cut, float weight){
...
void CHElJets_v3_sig_jecFlav::BeginEvent( )throw( LQError ){
...
void CHElJets_v3_sig_jecFlav::MakeHistograms(TString label){
  ...
  Message("Made histograms", INFO);
	/**
	 *  Remove//Overide this CHElJets_v3_sig_jecFlavCore::MakeHistograms() to make new hists for your analysis
	 **/
...
void CHElJets_v3_sig_jecFlav::ClearOutputVectors() throw(LQError) {
...
void CHElJets_v3_sig_jecFlav::mysort(std::vector<snu::KJet> jetColl_lepveto, int jet_index[]){
