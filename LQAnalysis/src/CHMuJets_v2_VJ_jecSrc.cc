...
/***************************************************************************
 * @Project: LQCHMuJets_v2_VJ Frame - ROOT-based analysis framework for Korea SNU
 * @Package: LQCycles
 *
...
/// Local includes
#include "CHMuJets_v2_VJ_jecSrc.h"
...
ClassImp (CHMuJets_v2_VJ_jecSrc);

/**
 *   This is an Example Cycle. It inherits from AnalyzerCore. The code contains all the base class functions to run the analysis.
 *
 */
CHMuJets_v2_VJ_jecSrc::CHMuJets_v2_VJ_jecSrc() :  AnalyzerCore(),  out_electrons(0) {

	// To have the correct name in the log:
 
	SetLogName("CHMuJets_v2_VJ_jecSrc");
	Message("In CHMuJets_v2_VJ_jecSrc constructor", INFO);
	//
...
void CHMuJets_v2_VJ_jecSrc::InitialiseAnalysis() throw( LQError ) {
...
void CHMuJets_v2_VJ_jecSrc::ExecuteEvents()throw( LQError ){
...
int CHMuJets_v2_VJ_jecSrc::ExecuteSystematics(int method, TString label)throw( LQError ){
...
void CHMuJets_v2_VJ_jecSrc::EndCycle()throw( LQError ){
  
	Message("In EndCycle" , INFO);
}


void CHMuJets_v2_VJ_jecSrc::BeginCycle() throw( LQError ){
...
CHMuJets_v2_VJ_jecSrc::~CHMuJets_v2_VJ_jecSrc() {
  
	Message("In CHMuJets_v2_VJ_jecSrc Destructor" , INFO);
	if(!k_isdata)delete reweightPU;
	if(!k_isdata) delete fBTagSF;
	//	delete minuit;
}
         
void CHMuJets_v2_VJ_jecSrc::FillCutFlow(TString label,TString cut, float weight){
...
void CHMuJets_v2_VJ_jecSrc::BeginEvent( )throw( LQError ){
...
void CHMuJets_v2_VJ_jecSrc::MakeHistograms(TString label){
  ...
  Message("Made histograms", INFO);
	/**
	 *  Remove//Overide this CHMuJets_v2_VJ_jecSrcCore::MakeHistograms() to make new hists for your analysis
	 **/
...
void CHMuJets_v2_VJ_jecSrc::ClearOutputVectors() throw(LQError) {
...
void CHMuJets_v2_VJ_jecSrc::mysort(std::vector<snu::KJet> jetColl_lepveto, int jet_index[]){
