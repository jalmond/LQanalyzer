...
ClassImp (CHElJets_v2_sig);

/**
 *   This is an Example Cycle. It inherits from AnalyzerCore. The code contains all the base class functions to run the analysis.
 *
 */
CHElJets_v2_sig::CHElJets_v2_sig() :  AnalyzerCore(),  out_electrons(0) {

  // To have the correct name in the log:
 
  SetLogName("CHElJets_v2_sig");
  Message("In CHElJets_v2_sig constructor", INFO);
  //
...
void CHElJets_v2_sig::InitialiseAnalysis() throw( LQError ) {
...
void CHElJets_v2_sig::ExecuteEvents()throw( LQError ){
...
int CHElJets_v2_sig::ExecuteSystematics(int method, TString label)throw( LQError ){
...
void CHElJets_v2_sig::EndCycle()throw( LQError ){
  
  Message("In EndCycle" , INFO);
}


void CHElJets_v2_sig::BeginCycle() throw( LQError ){
...
CHElJets_v2_sig::~CHElJets_v2_sig() {
  
  Message("In CHElJets_v2_sig Destructor" , INFO);
  if(!k_isdata)delete reweightPU;
  if(!k_isdata) delete fBTagSF;
  //	delete minuit;
}
         
void CHElJets_v2_sig::FillCutFlow(TString label,TString cut, float weight){
...
void CHElJets_v2_sig::BeginEvent( )throw( LQError ){
...
void CHElJets_v2_sig::MakeHistograms(TString label){
  ...
  /**
   *  Remove//Overide this CHElJets_v2_sigCore::MakeHistograms() to make new hists for your analysis
   **/
...
void CHElJets_v2_sig::ClearOutputVectors() throw(LQError) {
...
void CHElJets_v2_sig::mysort(std::vector<snu::KJet> jetColl_lepveto, int jet_index[]){
