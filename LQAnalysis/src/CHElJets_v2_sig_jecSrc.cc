...
/***************************************************************************
 * @Project: LQCHElJets_v2_sig Frame - ROOT-based analysis framework for Korea SNU
 * @Package: LQCycles
 *
...
/// Local includes
#include "CHElJets_v2_sig_jecSrc.h"
...
ClassImp (CHElJets_v2_sig_jecSrc);

/**
 *   This is an Example Cycle. It inherits from AnalyzerCore. The code contains all the base class functions to run the analysis.
 *
 */
CHElJets_v2_sig_jecSrc::CHElJets_v2_sig_jecSrc() :  AnalyzerCore(),  out_electrons(0) {

	// To have the correct name in the log:
 
	SetLogName("CHElJets_v2_sig_jecSrc");
	Message("In CHElJets_v2_sig_jecSrc constructor", INFO);
	//
...
void CHElJets_v2_sig_jecSrc::InitialiseAnalysis() throw( LQError ) {
...
void CHElJets_v2_sig_jecSrc::ExecuteEvents()throw( LQError ){
...
int CHElJets_v2_sig_jecSrc::ExecuteSystematics(int method, TString label)throw( LQError ){
...
void CHElJets_v2_sig_jecSrc::EndCycle()throw( LQError ){
  
	Message("In EndCycle" , INFO);
}


void CHElJets_v2_sig_jecSrc::BeginCycle() throw( LQError ){
...
CHElJets_v2_sig_jecSrc::~CHElJets_v2_sig_jecSrc() {
  
	Message("In CHElJets_v2_sig_jecSrc Destructor" , INFO);
...
void CHElJets_v2_sig_jecSrc::FillCutFlow(TString label,TString cut, float weight){
...
void CHElJets_v2_sig_jecSrc::BeginEvent( )throw( LQError ){
...
void CHElJets_v2_sig_jecSrc::MakeHistograms(TString label){
  ...
  Message("Made histograms", INFO);
	/**
	 *  Remove//Overide this CHElJets_v2_sig_jecSrcCore::MakeHistograms() to make new hists for your analysis
	 **/
...
void CHElJets_v2_sig_jecSrc::ClearOutputVectors() throw(LQError) {
...
void CHElJets_v2_sig_jecSrc::mysort(std::vector<snu::KJet> jetColl_lepveto, int jet_index[]){
