#ifndef HNCommonLeptonFakesTriLep_H
#define HNCommonLeptonFakesTriLep_H
...
class HNCommonLeptonFakesTriLep {

 public:
  /// Destructor
  ~HNCommonLeptonFakesTriLep();

  /// constructor
  HNCommonLeptonFakesTriLep(std::string path = "../share/", bool usegev=false);
