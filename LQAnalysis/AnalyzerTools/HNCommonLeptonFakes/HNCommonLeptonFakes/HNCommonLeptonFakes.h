...
//Declaration of the function
  ...
  float get_dilepton_mm_eventweight(TString fakerates, bool geterr, std::vector<TLorentzVector> muons, bool isT1, bool isT2, TString ID, bool c1, bool c2, TString method, float ptcorr1, float ptcorr2,bool checkcj);
