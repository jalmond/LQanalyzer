...
then
    ...
    #declare -a input_samples=("DY10to50" "DY50plus" "ttbar" "WZ" "ZZ" "WW" "SSWmWm" "SSWpWp" "WW_dp" "ttW" "ttZ")
    declare -a input_samples=("Wbb" "Zbb" "DYee" "DYmm" "DYtt" "HtoZZ" "Wgamma" "Zgamma" "WgammaE" "WWmg" "WZtollqq" "WZtoqqln" "WZtollln" "ZZtollnn" "ZZtollqq" "ZZtollll" "ZZtoeemm" "ZZtoeett" "ZZtommtt" "ZZtommmm" "ZZtoeeee" "ZZtotttt" "Wjets" ) 
    source submit.sh
fi    
################ DOUBLEELECTRON DATA
