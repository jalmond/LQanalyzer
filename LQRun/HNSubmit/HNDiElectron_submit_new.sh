...
#sktree -a HNDiElectron  -S SingleElectron -s SKTree_HNDiLepSkim  -n 50 -F
sktree -a HNDiElectron  -list hn_ll_ee1 -s FLATCAT 
#sktree -a HNDiElectron  -list  dilepton_list2 -s SKTree_DiLepSkim 
