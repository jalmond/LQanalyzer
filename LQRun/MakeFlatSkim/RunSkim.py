...
from ExtractListFromDatasetFile import *

version = os.getenv("CATVERSION")

### GetList returns list of all datasets on snu server minus any rare samples not needed for HN
sampledir=GetList()
...
for i in sampledir:
   ...
   for j in range(1,counter+1):
       ...
       outputFile.write("#$ -wd  /data2/LQ_SKTreeOutput/skim/jalmond/" +i+"/" + str(j) +"/"+ " \n")
       outputFile.write("#$ -o  /data2/LQ_SKTreeOutput/skim/jalmond/"   +i+"/"+ str(j) + "/"  " \n")
       outputFile.write("#$ -e  /data2/LQ_SKTreeOutput/skim/jalmond/"  +i+"/" + str(j) + "/" + " \n")
       ...
       outputFile.write("cd /data2/LQ_SKTreeOutput/skim/jalmond/"  +i+"/" + str(j) + "/" + " \n")
       outputFile.write("root -l -q -b " +  output+ "/" + str(j) + "/SkimFlatCat.C ")
       outputFile.write("echo 'Ran macro 2' \n")
       outputFile.write("")
       outputFile.close()
       command3 = "qsub -V  /data2/LQ_SKTreeOutput/skim/jalmond/" +i + "/" + str(j) + "/Run_" + str(j) + ".sh \n"
       print "qsub -V  /data2/LQ_SKTreeOutput/skim/jalmond/" +i + "/" + str(j) + "/Run_" + str(j) + ".sh"
   ...
   os.system("source /data2/LQ_SKTreeOutput/skim/jalmond/" +i + "/run.sh")    
