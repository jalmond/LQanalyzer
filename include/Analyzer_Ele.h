#ifndef Analyzer_Ele_h
#define Analyzer_Ele_h
...
class Analyzer_Ele : public Data {
...
//  static const Double_t integratedlumi = 83.483; HLT_Mu24
  static const Double_t integratedlumi = 49.542900;
  ...
  Bool_t VETO, SINGLEFAKE, DOUBLEFAKE, b_found;
 ...
 public:
  ...
  SignalPlots *h_signal, *h_signalMET50, *h_signalbTag, *h_signalTOT;
