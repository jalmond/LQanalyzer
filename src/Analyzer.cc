...
void Analyzer::Loop() {
  ...
  for (Long64_t jentry = 0; jentry < nentries; jentry++ ) {
    ...
    if(all_muons.size()>1){
      ...
      cout << "Muon 1 has pt " << all_muons.at(0).Pt() << endl;
      cout << "Muon 1 has eta " << all_muons.at(0).Eta() << endl;
      cout << "Muon 1 isPF= " << all_muons.at(0).IsPF() << endl;
      cout << "Muon 1 has charge " << all_muons.at(0).Pt() << endl;
      
      cout << "Muon 1 has iso charged hadrons = " << all_muons.at(0).IsoR03ch() << endl;
