...
SignalPlots::SignalPlots(TString name): StdPlots(name){
  ...
  map_sig["h_llmass"] =         new TH1F("h_llmass_"        + name,"Invariant mass of the two leading muons",100,0,1000);
  ...
  map_sig["h_WandNmass"] =      new TH2F("h_WandNmass_"     + name,"Invariant mass of the W and the N",200,0,2000,200,0,2000);
  map_sig["h_3Dparm"] =         new TH3F("h_3Dpar_"         + name,"m(lljj) and muon p_{T}_{1} and muon p_{T}_{2}",200,0,2000,60,0,300,60,0,300);
  ...
  map_sig["h_cosTheta1"] =      new TH1F("h_cosTheta1_"     + name,"cos#theta first muon",100,-1,1);
  map_sig["h_cosTheta2"] =      new TH1F("h_cosTheta2_"     + name,"cos#theta second muon",100,-1,1);
  map_sig["h_Njets"] =          new TH1F("h_Njets_"         + name,"number of jets",10,0,10);
}


//// NEED TO WRITE FILL CODE
...
void SignalPlots::Fill(snu::KEvent ev, std::vector<snu::KMuon>& muons, std::vector<snu::KElectron>& electrons, std::vector<snu::KJet>& jets, Double_t weight) {
  ...
  for(UInt_t i=0; i<muons.size(); i++)
	...
	for(UInt_t enne=1; enne<jets.size(); enne++) {
      ...
      Fill("h_llmass", (muons[i]+electrons[j]).M(),weight);
      Fill("h_l1jjmass", (muons[i]+jets[m]+jets[n]).M(),weight);
      Fill("h_l2jjmass", (electrons[j]+jets[m]+jets[n]).M(),weight);
      Fill("h_lljjmass", (muons[i]+electrons[j]+jets[m]+jets[n]).M(),weight);
      Fill("h_WandNmass", (muons[i]+electrons[j]+jets[m]+jets[n]).M() , (electrons[j]+jets[m]+jets[n]).M(),weight);      
      Fill("h_3Dparm", (muons[i]+electrons[j]+jets[m]+jets[n]).M(), muons[i].Pt(), electrons[j].Pt(), weight); 
      Fill("h_leadingMuonPt", muons[i].Pt(),weight);
      Fill("h_leadingElectronPt", electrons[j].Pt(),weight);
      Fill("h_leadingJetPt", jets[m].Pt(),weight);
      Fill("h_secondJetPt", jets[n].Pt(),weight);
      Fill("h_leadingMuonIso", muons[i].RelIso(),weight);
      //Fill("h_leadingElectronIso", electrons[j].RelIso(),weight);
