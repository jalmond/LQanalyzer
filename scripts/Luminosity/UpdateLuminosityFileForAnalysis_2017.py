...
tmpcatversion="v9-4-9v2"
#"str(os.getenv("SKFLATVERSION"))

print "CATVERSION = " + str(tmpcatversion)

newsamplelist=os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_CAT_mc_"+tmpcatversion+"new.txt"
...
def CheckForDuplicates(printDuplicates):
    ...
    samplelist=os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_CAT_mc_"+catversion+".txt"
    ...
    duplicates=[]
    xsec_duplicates=[]
    rd_samplelist=os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_CAT_mc_"+catversion+"_removeduplicates.txt"
...
def UpdateLumiFile(modlistpath, catversion, NewSampleList):
    ...
    samplelist=os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_CAT_mc_"+catversion+".txt"
    os.system("chmod 777 "  + samplelist)
    newsamplelist=os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_CAT_mc_"+catversion+"new.txt"                                                               
    os.system("chmod 777 "  + newsamplelist)
...
catversion="v9-4-9v2"
#str(os.getenv("CATVERSION"))

path_full_sample_list=os.getenv("LQANALYZER_DATASET2017_DIR")+"/cattuplist_"+catversion+".txt"
path_full_sample_list_user=os.getenv("LQANALYZER_DATASET2017_DIR")+"/"+ os.getenv("USER")  +"/cattuplist_"+catversion+ os.getenv("USER")+".txt"
...
if not os.path.exists(os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_CAT_mc_"+catversion+".txt"):
...
if os.path.exists(path_full_sample_list):
    ...
    if filecmp.cmp(path_full_sample_list,path_full_sample_list_user):
        ...
        for line in file_user:
            ...
            file_mc = open(os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_CAT_mc_" + catversion + ".txt","r") 
            inMCfile=False
        ...
        path_newfile=os.getenv("LQANALYZER_DATASET2017_DIR")+"/"+os.getenv("USER")+"/newfile.txt"
        #### rename variables later
        path_newfile2=os.getenv("LQANALYZER_DATASET2017_DIR")+"/"+os.getenv("USER")+"/newfile2.txt"
        path_newfile3=os.getenv("LQANALYZER_DATASET2017_DIR")+"/"+os.getenv("USER")+"/newfile3.txt"
        ...
        os.system("source " + os.getenv("LQANALYZER_DIR")+"/scripts/Luminosity/runGetEffLumi2017.sh " + path_newfile + " new ")
        print "source " + os.getenv("LQANALYZER_DIR")+"/scripts/Luminosity/runGetEffLumi2017.sh " + path_newfile + " new "
        print "\n"
        
        if not  os.path.exists(os.getenv("LQANALYZER_DIR")+"/scripts/Luminosity/datasets_snu_CAT_mc_" + catversion + "new.txt"):

            print  os.getenv("LQANALYZER_DIR")+"/scripts/Luminosity/runGetEffLumi2017.sh was meant to produce file "+ os.getenv("LQANALYZER_DIR")+"/scripts/Luminosity/datasets_snu_CAT_mc_" + catversion + "new.txt"
            ...
            if not os.getenv("USER") =="jalmond":
                ...
                if input == "Y":
                    ...
                    os.system("chmod  -R 777 " + os.getenv("LQANALYZER_DATASETFILE2017_DIR") )
        ...
        print "Running runInputListMaker2017.sh: Note this may take several minutes..."    
        os.system("source " + os.getenv("LQANALYZER_DIR")+"/scripts/runInputListMaker2017.sh")
        ...
        if len(newsample_list) > 0:
            ...
            file_newlist.close()                                                                                                      
            os.system("cp " + os.getenv("LQANALYZER_DIR")+"/LQRun/txt/list_user_94Xmc.sh " + os.getenv("LQANALYZER_DIR")+"/LQRun/txt/list_user_mctmp.sh")
            file_userlist = open(os.getenv("LQANALYZER_DIR")+"/LQRun/txt/list_user_94Xmc.sh","a")
            addstring = "declare -a new_list=("
            isSIG=False
            runSKTreemaker=False
            for l in list_new:
                if os.path.exists("/data2/CatNtuples/v9-4-9v2/SKTrees/MC/"+str(l)):
            ...
            os.system("python UpdateSIGFormat.py -x " +os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_CAT_mc_" + catversion + ".txt -y " +os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_sig_CAT_mc_" + catversion + ".txt -z "  +os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_nonsig_CAT_mc_" + catversion + ".txt")             
            
            if runSKTreemaker:
                if isSIG:
                    os.system("bash " + os.getenv("LQANALYZER_DIR")+"/bin/submitSKTree94X.sh -M True -a SKTreeMaker -list new_list -c " + catversion + " -m ' first time sample is made in current catversion' -SIG")
                else:
                    os.system("bash " + os.getenv("LQANALYZER_DIR")+"/bin/submitSKTree94X.sh -M True -a SKTreeMaker -list new_list -c " + catversion + " -m ' first time sample is made in current catversion'")
                    
            os.system("mv " +  os.getenv("LQANALYZER_DIR")+"/LQRun/txt/list_user_mctmp.sh " + os.getenv("LQANALYZER_DIR")+"/LQRun/txt/list_user_94Xmc.sh")
    ...
    print "source " + lqdir+"/scripts/Luminosity/runGetEffLumi2017.sh " + os.getenv("LQANALYZER_DATASET2017_DIR")+"/cattuplist_v9-4-9v2.txt"
    ...
    os.system("source " + lqdir+"/scripts/Luminosity/runGetEffLumi2017.sh " + os.getenv("LQANALYZER_DATASET2017_DIR")+"/cattuplist_v9-4-9v2.txt")

    print "Finished GetEff"
    if os.path.exists(lqdir+"/scripts/Luminosity/log"):
        os.system("rm -r "+lqdir+"/scripts/Luminosity/log")

    print "Running scripts/runInputListMaker2017.sh"
    ...
    os.system("cp " +os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/skel/datasets_snu_sig_CAT_mc_v9-4-X.txt " +os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_sig_CAT_mc_" + catversion + ".txt")
    os.system("cp " +os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/skel/datasets_snu_nonsig_CAT_mc_v9-4-X.txt " +os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_nonsig_CAT_mc_" + catversion + ".txt")
    os.system("python UpdateSIGFormat.py -x " +os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_CAT_mc_" + catversion + ".txt -y " +os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_sig_CAT_mc_" + catversion + ".txt -z "  +os.getenv("LQANALYZER_DATASETFILE2017_DIR") +"/datasets_snu_nonsig_CAT_mc_" + catversion + ".txt")        

    
    os.system('bash ' + os.getenv('LQANALYZER_DIR')+'/bin/submitSKTree94X.sh -M True -a  SKTreeMaker -list all_mc  -c '+catversion+' -m "First set of cuts with '+catversion+'cattuples"')
    os.system('bash  ' + os.getenv('LQANALYZER_DIR')+'/bin/submitSKTree94X.sh -M True -a  SKTreeMakerDiLep -list all_mc  -c '+catversion+'  -m "First set of cuts with '+catversion+' cattuples"')
    os.system('bash  ' + os.getenv('LQANALYZER_DIR')+'/bin/submitSKTree94X.sh -M True -a  SKTreeMakerTriLep -list all_mc  -c '+catversion+'  -m "First set of cuts with '+catversion+' cattuples"')
