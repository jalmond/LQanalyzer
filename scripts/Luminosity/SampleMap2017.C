#ifndef SampleMap2017_C
#define SampleMap2017_C
...
vector<TString>  GetAvailableMap(TString cversion, TString listpath){
  ...
  TString dir = "ls   " + TString(getenv("LQANALYZER_DATASET2017_DIR"))+"/datasets_" + cversion + "/ > inputlist_map.txt";
  ...
  for(unsigned int i=0; i < input_datasetlist.size(); i++){
    std::ifstream fdin( ( string(getenv("LQANALYZER_DATASET2017_DIR")) +"/datasets_" + cversion + "/" + input_datasetlist.at(i)).Data());
