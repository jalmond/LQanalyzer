...
import ExtractListFromDatasetFile_kisti
...
if os.path.exists(path_full_sample_list):
    ...
    if filecmp.cmp(path_full_sample_list,path_full_sample_list_user):
        ...
        os.system("source " + os.getenv("LQANALYZER_DIR")+"/scripts/Luminosity/runGetEffLumiKisti.sh " + path_newfile + " new ")
        print "source " + os.getenv("LQANALYZER_DIR")+"/scripts/Luminosity/runGetEffLumiKisti.sh " + path_newfile + " new "
        print "\n"
        
        if not  os.path.exists(os.getenv("LQANALYZER_DIR")+"/scripts/Luminosity/datasets_snu_CAT_mc_" + catversion + "new.txt"):

            print  os.getenv("LQANALYZER_DIR")+"/scripts/Luminosity/runGetEffLumiKisti.sh was meant to produce file "+ os.getenv("LQANALYZER_DIR")+"/scripts/Luminosity/datasets_snu_CAT_mc_" + catversion + "new.txt"
