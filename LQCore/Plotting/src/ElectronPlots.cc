...
ElectronPlots::ElectronPlots(TString name) : StdPlots(name) {
  ...
  map_el["h_ispf"]   = new TH1D("h_ispf"+ name, "",2 ,0. ,2. );
  ...
  map_el["h_snuid"]   = new TH1D("h_snuid"+ name, "",1000 ,0. ,1000000. );
  ...
  map_el["h_dxy"]   = new TH1D("h_dxy"+name , "", 1000, -1., 1.);
  map_el["h_dz"]   = new TH1D("h_dz"+name , "", 1000, -1., 1.);
  map_el["h_dxysig"]   = new TH1D("h_dxysig"+name , "", 1000, -10., 10.);
  map_el["h_trkvx"]   = new TH1D("h_trkvx"+name , "", 1000, -2., 2.);
  map_el["h_trkvy"]   = new TH1D("h_trkvy"+name , "", 1000, -2., 2.);
  map_el["h_trkvz"]   = new TH1D("h_trkvz"+name , "", 1000, -2., 2.);
