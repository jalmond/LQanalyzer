...
class FatJetSelection : public BaseSelection {
 ...
 public:
  ...
  void SelectFatJets(std::vector<snu::KFatJet>& jetColl, TString jetid,   std::vector<snu::KMuon> muonColl, std::vector<snu::KElectron> electronColl,   TString Option="",float ptcut=-999., float etacut=-999.);
