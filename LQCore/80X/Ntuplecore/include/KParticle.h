#ifndef KPARTICLE_H__
#define KPARTICLE_H__
...
namespace snu {
  ...
  public:
    ...
    bool CheckIDList(TString IDlabel, TString IDlabelref, std::vector<TString>& IDlist);    
    
    void SetCharge(Int_t c);        

    
    Double_t AbsEta() const {return fabs(this->Eta());}
