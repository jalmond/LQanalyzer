...
class FatJetSelection : public BaseSelection {
 ...
 public:
  ...
  void SelectFatJets(std::vector<snu::KFatJet>& jetColl, float ptcut=-999., float etacut=-999.);
  ...
  void SelectFatJets(std::vector<snu::KFatJet>& jetColl,   std::vector<snu::KMuon> muonColl, std::vector<snu::KElectron> electronColl,   float ptcut=-999., float etacut=-999.);
