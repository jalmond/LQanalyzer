...
BaseSelection::BaseSelection() {
  ...
  apply_id_loose=false;
  apply_id_medium=false;
  apply_id_tight=false;
  apply_ptcut=false;
  apply_etacut=false;
  apply_jptcut=false;
...
bool BaseSelection::MakeCut(double val){
...
BaseSelection& BaseSelection::operator= (const BaseSelection& bs) 
{
  if(this != &bs){
    ...
    apply_id_loose=bs.apply_id_loose;
    apply_id_medium=bs.apply_id_medium;
    apply_id_tight=bs.apply_id_tight;
