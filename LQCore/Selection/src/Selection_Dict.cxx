//
// File generated by /programs/root/bin/rootcint at Wed Nov 20 01:29:09 2013
...
namespace ROOT {
   void EventBase_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      ...
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*k_LQevent", &sobj->k_LQevent);
...
{
      G__letint(result7, 85, (long) ((const EventBase*) G__getstructoffset())->GetEventBase());
   return(1 || funcname || hash || result7 || libp) ;
}
...
static void G__setup_memvarEventBase(void) {
   ...
   G__memvar_setup((void*)((long)(&p->k_LQevent)-(long)(p)),85,0,0,G__get_linked_tagnum(&G__Selection_DictLN_LQEvent),-1,-1,1,"k_LQevent=",0,(char*)NULL);
...
static void G__setup_memfuncEventBase(void) {
   ...
   G__memfunc_setup("GetEventBase",1181,G__Selection_Dict_684_0_18, 85, G__get_linked_tagnum(&G__Selection_DictLN_LQEvent), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   // automatic destructor
