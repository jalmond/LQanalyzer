...
void MakeCFPlot(TString path) {
  ...
  TH1F* hnum =  (TH1F*)fmc->Get(("CFNumerator_pt"));
  TH1F* hden =  (TH1F*)fmc->Get(("CFDenominator_pt"));
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/CF/CF_MCpt.pdf"));
