...
void Opt_ntuple_midmass_100(){
  ...
  f_chainsig->Add("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectron_ntup/HNDiElectron_SKHNee100_nocut_5_3_14.root");
  TFile * file = new TFile("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectron_ntup/HNDiElectron_SKHNee100_nocut_5_3_14.root");
  cout << file << endl;
  ...
  for(unsigned int imet=0; imet < METcut.size(); imet++){
    ...
    for(int imeejjmin= 11; imeejjmin < 15. ; imeejjmin++){
	  ...
	  for(int ipt2= 0; ipt2 < 2. ; ipt2++){
		...
		for(int ie1jjmin =8 ; ie1jjmin < 9 ; ie1jjmin++){
		    ...
		    for(int ie2jjmin =0 ; ie2jjmin < 6 ; ie2jjmin++){
		      float e2jjmin_cut = 40. + float(ie2jjmin)* 10.;
		      
		      for(int ie2jjmax =0 ; ie2jjmax < 10 ; ie2jjmax++){
			float e2jjmax_cut =  100. + float(ie2jjmax)* 5.;
