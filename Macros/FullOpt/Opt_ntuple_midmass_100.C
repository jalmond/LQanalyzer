...
void Opt_ntuple_midmass_100(){
  ...
  for(unsigned int imet=0; imet < METcut.size(); imet++){
    ...
    for(int imeejjmin= 0; imeejjmin < 1 ; imeejjmin++){
      float meejjmin_cut = 100. + float(imeejjmin) * 10.;
	...
	for(int ipt1= 0; ipt1 <1. ; ipt1++){
	  ...
	  for(int ipt2= 0; ipt2 < 1. ; ipt2++){
		...
		for(int ieemax =0 ; ieemax <1 ; ieemax++){
		  ...
		  for(int ie1jjmin =0 ; ie1jjmin < 5 ; ie1jjmin++){
		    float e1jjmin_cut = 70. + float(ie1jjmin)* 10.;
		    
		    for(int ie1jjmax =0 ; ie1jjmax < 10 ; ie1jjmax++){
		      float e1jjmax_cut = 100. + float(ie1jjmax)* 10.;
		      
		      for(int ie2jjmin =0; ie2jjmin < 1 ; ie2jjmin++){
			float e2jjmin_cut = 80. + float(ie2jjmin)* 10.;
