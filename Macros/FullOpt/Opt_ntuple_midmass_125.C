...
void Opt_ntuple_midmass_125(){
  ...
  for(unsigned int imet=0; imet < METcut.size(); imet++){
    ...
    for(int imeejjmin= 0; imeejjmin < 2 ; imeejjmin++){
      float meejjmin_cut = 140. + float(imeejjmin) * 10.;
	...
	for(int ipt1= 0; ipt1 <2. ; ipt1++){
	  ...
	  for(int ipt2= 0; ipt2 < 2. ; ipt2++){
	    ...
	    for(int ipt3= 0; ipt3 < 2. ; ipt3++){
              float pt3_cut = 20. + float(ipt3)*5.;
		...
		for(int ieemax =0 ; ieemax <1 ; ieemax++){
		  ...
		  for(int ie1jjmin =0 ; ie1jjmin < 1 ; ie1jjmin++){
			...
			float e2jjmin_cut = 90. + float(ie2jjmin)* 5.;
			
			for(int ie2jjmax =0; ie2jjmax < 1 ; ie2jjmax++){
			  float e2jjmax_cut =  145. + float(ie2jjmax)* 5.;
