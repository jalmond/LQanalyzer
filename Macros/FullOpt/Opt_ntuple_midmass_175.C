...
void Opt_ntuple_midmass_175(){
  ...
  f_chainsig->Add("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectron_ntup/HNDiElectron_SKHNee175_nocut_5_3_14.root");
  TFile * file = new TFile("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectron_ntup/HNDiElectron_SKHNee175_nocut_5_3_14.root");
  cout << file << endl;
  ...
  f_chain->SetBranchAddress("nbjet_l", &k_nbjet_l);
  f_chain->SetBranchAddress("nbjet_m", &k_nbjet_m);
  f_chain->SetBranchAddress("nbjet_t", &k_nbjet_t);
  ...
  f_chainmc->SetBranchAddress("nbjet_l", &k_nbjet_l);
  f_chainmc->SetBranchAddress("nbjet_m", &k_nbjet_m);
  f_chainmc->SetBranchAddress("nbjet_t", &k_nbjet_t);
  ...
  f_chainsig->SetBranchAddress("nbjet_l", &k_nbjet_l);
  f_chainsig->SetBranchAddress("nbjet_m", &k_nbjet_m);
  f_chainsig->SetBranchAddress("nbjet_t", &k_nbjet_t);
	...
	for(int ipt1= 4; ipt1 <20 ; ipt1++){
	  ...
	  for(int ipt2= 0; ipt2 < 10. ; ipt2++){
		...
		for(int ie1jjmin =8 ; ie1jjmin < 9 ; ie1jjmin++){
		    ...
		    for(int ie2jjmin =0 ; ie2jjmin < 8 ; ie2jjmin++){
		      float e2jjmin_cut = 100. + float(ie2jjmin)* 10.;
		      
		      for(int ie2jjmax =0 ; ie2jjmax < 10 ; ie2jjmax++){
			float e2jjmax_cut =  150. + float(ie2jjmax)* 10.;
