...
void Opt_ntuple_midmass_70(){
  ...
  for(unsigned int imet=0; imet < METcut.size(); imet++){
    ...
    for(int imeejjmin= 0; imeejjmin < 1. ; imeejjmin++){
      ...
      for(int imeejjmax= 0; imeejjmax <6. ; imeejjmax++){
	...
	for(int ipt1= 0; ipt1 <1. ; ipt1++){
	  ...
	  for(int ipt2= 0; ipt2 < 1. ; ipt2++){
		...
		for(int ieemax =0 ; ieemax <1 ; ieemax++){
		  ...
		  for(int ie1jjmin =0 ; ie1jjmin < 3 ; ie1jjmin++){
                  float e1jjmin_cut = 50. + float(ie1jjmin)* 10.;

                  for(int ie1jjmax =0 ; ie1jjmax < 5 ; ie1jjmax++){
                    float e1jjmax_cut =  140. + float(ie1jjmax)* 10.;
