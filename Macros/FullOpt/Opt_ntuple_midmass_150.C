...
void Opt_ntuple_midmass_150(){
  ...
  f_chainsig->Add("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectron_ntup/HNDiElectron_basic_SKHNee150_nocut_5_3_14.root");
  TFile * file = new TFile("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectron_ntup/HNDiElectron_basic_SKHNee150_nocut_5_3_14.root");
  cout << file << endl;
	  ...
	  for(int ipt2= 0; ipt2 < 4. ; ipt2++){
		...
		for(int ieemax =0 ; ieemax <1 ; ieemax++){
		  ...
		  for(int ie1jjmin =0 ; ie1jjmin < 1 ; ie1jjmin++){
			...
			for(int ie2jjmax =1; ie2jjmax < 5 ; ie2jjmax++){
			  float e2jjmax_cut =  160. + float(ie2jjmax)* 5.;
