...
void GetSigEfficiency(TString path){
  ...
  TH1F* h_pt10 =(TH1F*)file->Get(("Efficiency/eff_electronPt10CutColl"));
  ...
  TH1F* h_eta24 =(TH1F*)file->Get(("Efficiency/eff_electronEta24CutColl"));
  ...
  cout << "Pt 10 cut efficiency [%] = " <<100* h_pt10->Integral() / h_ref->Integral()<< endl;;
  ...
  cout << "Eta 24 cut efficiency [%] = " <<100* h_eta24->Integral() / h_ref->Integral()<< endl;;
