...
void Opt_ee(){
  ...
  TH1F* h_npcutflow= (TH1F*)fnp->Get(("SSee_DiJet/h_e2jjmass_SSee_DiJet"));
  TH1F* h_cfcutflow= (TH1F*)fcf->Get(("SSee_DiJet/h_e2jjmass_SSee_DiJet"));
  TH1F* h_mccutflow= (TH1F*)fmc->Get(("SSee_DiJet/h_e2jjmass_SSee_DiJet"));
  ...
  for(unsigned int imass=0; imass < masses.size(); imass++){
    ...
    TH1* hsig =  (TH1F*)fsig->Get(("SSee_DiJet/h_e2jjmass_SSee_DiJet"));
