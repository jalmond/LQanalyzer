...
void Opt_isocut(){
  ...
  for(unsigned int im=0; im < masses.size(); im++){
    ...
    TH1F* h_mass_isoopt = new TH1F(("isocut_opt_HN"+ masses.at(im)).Data(),("isocut_opt_HN"+ masses.at(im)).Data(), 16,0.,16.);
    h_mass_isoopt->GetXaxis()->SetBinLabel(1,"dr03_150");
    h_mass_isoopt->GetXaxis()->SetBinLabel(2,"dr03_125");
    h_mass_isoopt->GetXaxis()->SetBinLabel(3,"dr03_100");
    h_mass_isoopt->GetXaxis()->SetBinLabel(4,"dr03_090");
    h_mass_isoopt->GetXaxis()->SetBinLabel(5,"dr03_080");
    h_mass_isoopt->GetXaxis()->SetBinLabel(6,"dr03_070");
    h_mass_isoopt->GetXaxis()->SetBinLabel(7,"dr03_060");
    h_mass_isoopt->GetXaxis()->SetBinLabel(8,"dr03_050");
    h_mass_isoopt->GetXaxis()->SetBinLabel(9,"dr03_150");
    h_mass_isoopt->GetXaxis()->SetBinLabel(10,"dr04_125");
    h_mass_isoopt->GetXaxis()->SetBinLabel(11,"dr04_100");
    h_mass_isoopt->GetXaxis()->SetBinLabel(12,"dr04_090");
    h_mass_isoopt->GetXaxis()->SetBinLabel(13,"dr04_080");
    h_mass_isoopt->GetXaxis()->SetBinLabel(14,"dr04_070");
    h_mass_isoopt->GetXaxis()->SetBinLabel(15,"dr04_060");
    h_mass_isoopt->GetXaxis()->SetBinLabel(16,"dr04_050");

    for(int i= 1; i < h_mass_isoopt->GetNbinsX()+1 ;i++){
      float sig_eff = h_cutflow->GetBinContent(i)/ h_cutflow_ref->GetBinContent(1); 
    ...
    h_mass_isoopt->GetYaxis()->SetRangeUser(0.001, 0.2);
  ...
  legend->Draw("same");
  c1->SaveAs(("/home/jalmond/WebPlots/Opt/isooptimise.pdf"));
}
