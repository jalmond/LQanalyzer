...
void Opt_ntuple_midmass_100(){
  ...
  for(unsigned int imet=0; imet < METcut.size(); imet++){
    ...
    for(int imeejjmin= 10; imeejjmin < 11. ; imeejjmin++){
	...
	for(int ipt1= 0; ipt1 <1. ; ipt1++){
	  ...
	  for(int ipt2= 0; ipt2 < 1. ; ipt2++){
		...
		for(int ie1jjmin =8 ; ie1jjmin < 9 ; ie1jjmin++){
		    ...
		    for(int ie2jjmin =8 ; ie2jjmin < 9 ; ie2jjmin++){
		      float e2jjmin_cut = 40. + float(ie2jjmin)* 5.;
		      
		      for(int ie2jjmax =3 ; ie2jjmax < 4 ; ie2jjmax++){
			...
			for(int ihtmin =0 ; ihtmin < 1 ; ihtmin++){
			  ...
			  for(int ihtmax =16 ; ihtmax < 17 ; ihtmax++){
			    ...
			    for(int istmin =8 ; istmin < 20 ; istmin++){
