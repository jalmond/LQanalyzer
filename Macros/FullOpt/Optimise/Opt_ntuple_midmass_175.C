...
void Opt_ntuple_midmass_175(){
  ...
  for(unsigned int imet=0; imet < METcut.size(); imet++){
    ...
    for(int imeejjmin= 17; imeejjmin < 25. ; imeejjmin++){
	  ...
	  for(int ipt2= 0; ipt2 < 3; ipt2++){
		...
		for(int ie1jjmin =8 ; ie1jjmin < 9 ; ie1jjmin++){
		    ...
		    for(int ie2jjmin =0 ; ie2jjmin < 4 ; ie2jjmin++){
		      float e2jjmin_cut = 120. + float(ie2jjmin)* 5.;
		      
		      for(int ie2jjmax =0 ; ie2jjmax < 3 ; ie2jjmax++){
			float e2jjmax_cut =  180. + float(ie2jjmax)* 10.;
