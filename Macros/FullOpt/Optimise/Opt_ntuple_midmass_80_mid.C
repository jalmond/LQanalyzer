...
void Opt_ntuple_midmass_80_mid(){
  ...
  for(unsigned int imet=0; imet < METcut.size(); imet++){
    ...
    for(int imeejjmin= 8; imeejjmin < 11. ; imeejjmin++){
      float meejjmin_cut = float(imeejjmin) * 10.;
      for(int imeejjmax= 0; imeejjmax <1. ; imeejjmax++){
	float meejjmax_cut = 100000.+ float(imeejjmax)*10.;
	...
	for(int ipt1= 0; ipt1 <3. ; ipt1++){
	  ...
	  for(int ipt2= 0; ipt2 < 3. ; ipt2++){
	    ...
	    for(int ieemin =1 ; ieemin < 6 ; ieemin++){
		...
		for(int ie1jjmin =8 ; ie1jjmin < 9 ; ie1jjmin++){
		    ...
		    for(int ie2jjmin =2 ; ie2jjmin < 8 ; ie2jjmin++){
		      float e2jjmin_cut = 40. + float(ie2jjmin)* 5.;
		      
		      for(int ie2jjmax =0; ie2jjmax < 8 ; ie2jjmax++){
