...
void GetPDFUncert_700(){
  
  
  setTDRStyle();
  //gStyle->SetPalette(1);
  
  TString spath = "/home/jalmond/Analysis/LQanalyzer/data/output/SSElectron/HNDiElectron_SKHNee700_nocut_5_3_14.root";
  ...
  h_nnpdf_total->GetYaxis()->SetRangeUser(0.125, 0.14);
