...
void MakeMCClosurePlot_region2(){
  ...
  TH1F* h_qcd2_doubletosingle= (TH1F*)fqcd2->Get("MCclosure/HNTightregion2MCSSclosure_mcclosure_Doubletosingle");
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/PreApproval/MCclosure/DoubleToSingle_looseregion2.pdf"));
