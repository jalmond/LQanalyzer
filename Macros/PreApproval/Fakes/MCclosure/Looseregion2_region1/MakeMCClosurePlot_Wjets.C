...
void MakeMCClosurePlot_Wjets(){
  ...
  collection.push_back("MCclosure/HNTight_loosereg2region1MCSSclosure");
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/PreApproval/MCclosure/WjetMCclosure_looseregion2_region1.pdf"));
