...
void MakeMCClosurePlot(){
  ...
  TH1F* h_qcd2_doubletosingle= (TH1F*)fqcd2->Get("MCclosure/HNTight_loosereg2region2MCSSclosure_mcclosure_Doubletosingle");
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/PreApproval/MCclosure/DoubleToSingle_looseregion2_region2.pdf"));
