...
void MakeFRRootFile_mcerror(){
  ...
  TString outfile = "FakeRate2015_mcerror.root";
  ...
  for(vector<TString>::iterator it = type.begin(); it!=type.end(); ++it){
    for(vector<TString>::iterator it2 = fakes40.begin(); it2!=fakes40.end(); ++it2){
      ...
      TH2F* eff_rate2 = (TH2F*)h_pt_num->Clone(("FakeRate_mcerror_" + tag).Data());
      TH2F* hratedenom2 = (TH2F*)h_pt_denom->Clone((tag +"2_denom").Data());    
      eff_rate2->Add(h_mcpt_num,-1.15);
      hratedenom2->Add(h_mcpt_denom, -1.15);
      
      TH2F* eff_rate3 = (TH2F*)h_pt_num->Clone(("FakeRate_mcerror_" + tag).Data());
      TH2F* hratedenom3 = (TH2F*)h_pt_denom->Clone((tag +"3_denom").Data());
      eff_rate3->Add(h_mcpt_num,-0.85);
      hratedenom3->Add(h_mcpt_denom, -0.85);


            
      eff_rate->Divide(eff_rate,hratedenom,1.,1.,"cl=0.683 b(1,1) mode");
      eff_rate2->Divide(eff_rate2,hratedenom2,1.,1.,"cl=0.683 b(1,1) mode");
      eff_rate3->Divide(eff_rate3,hratedenom3,1.,1.,"cl=0.683 b(1,1) mode");
      
      TH2F* error_mc_up = (TH2F*)eff_rate->Clone(("MCerror_up_" + tag).Data());
      TH2F* error_mc_down = (TH2F*)eff_rate->Clone(("MCerror_down_" + tag).Data());


      error_mc_up->Add(eff_rate2, -1.);
      error_mc_up->Divide(error_mc_up,eff_rate, 1.,1.,"cl=0.683 b(1,1) mode");
      error_mc_up->Write();

      error_mc_down->Add(eff_rate3, -1.);
      error_mc_down->Divide(error_mc_down,eff_rate, 1.,1.,"cl=0.683 b(1,1) mode");
      error_mc_down->Write();
