...
void MakeFRMCall_highstattop(){
  
  TString path_ttbar = "/home/jalmond/Analysis/LQanalyzer/data/output/ElectronFakes//MC/FakeRateCalculator_El_SKtopLJ_5_3_14.root";
  ...
  list_of_names.push_back("nocb_eta_ht4");
  list_of_names.push_back("nocb_eta_ht5");
  list_of_names.push_back("nocb_eta_ht6");
  list_of_names.push_back("nocb_pt_ht1");
  list_of_names.push_back("nocb_pt_ht2");
  list_of_names.push_back("nocb_pt_ht3");
  list_of_names.push_back("nocb_pt_ht4");
  list_of_names.push_back("nocb_pt_ht5");
  list_of_names.push_back("nocb_pt_ht6");
  ...
  for(unsigned int j = 0; j < list_of_regions.size(); j++){
	...
	h_qcd_tight->GetXaxis()->SetBinLabel(2,"bjet:  #DeltaR< 0.4");
      ...
      c1->SaveAs(("/home/jalmond/WebPlots/PreApproval/Fakes/MCFake_all_highstattop_" + list_of_regions.at(j ) + "_" + list_of_names.at(i) + ".pdf").Data());
    }
