...
void GetRes(){
  ...
  h_res_50->GetYaxis()->SetTitle("");
  h_res_50->GetXaxis()->SetTitle("m_{N} GeV");
  h_res_50->GetYaxis()->SetRangeUser(0., 0.2);
  h_res_50->GetXaxis()->SetRangeUser(0., 400);
  h_res_50->Scale(1./ h_res_50->Integral());
  h_res_60->Scale(1./ h_res_60->Integral());
  h_res_100->Scale(1./ h_res_100->Integral());
  h_res_300->Scale(1./ h_res_300->Integral());


  h_res_50->GetYaxis()->SetRangeUser(0., 0.1);
  h_res_50->Draw("hist");
  h_res_60->Draw("histsame");
  ...
  legendH->AddEntry(h_res_50, "m_N = 50 GeV", "l");
  legendH->AddEntry(h_res_60, "m_N = 60 GeV", "l");
  legendH->Draw();
  
  c1->SaveAs(("/home/jalmond/WebPlots/PreApproval/Res/MuonHN_res.pdf"));
