...
void GetSigEfficiency_nojets(){
  ...
  vector<float>  isoid,id , elid, jet, total;
  ...
  TLegend* legendH = new TLegend(0.2, 0.7, 0.5, 0.9);
  ...
  total_hist->GetYaxis()->SetRangeUser(0.,.1);
  total_hist->Draw("p");
  el_hist->Draw("psame");
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/PreApproval/SignalPlots/SignalEff_nojets.pdf" ));
}
