...
void MakeNPunziLowMass_opt2(){
  ...
  TH1F* tight_anal4 = makehist("PreSelection_lowmass4");
  TH1F* tight_anal5 = makehist("PreSelection_lowmass5");
  TH1F* tight_anal6 = makehist("PreSelection_lowmass6");
  TH1F* tight_anal7 = makehist("PreSelection_lowmass7");
  ...
  legendH->AddEntry(tight_anal2, "e2jj < 160", "p");
  legendH->AddEntry(tight_anal3, "e2jj < 140", "p");
  legendH->AddEntry(tight_anal4, "e2jj <120", "p");
  legendH->AddEntry(tight_anal5, "mee < 70. && e2jj < 160", "p");
  legendH->AddEntry(tight_anal6, "mee < 70. && e2jj < 140", "p");
  legendH->AddEntry(tight_anal7, "mee < 70. &&  e2jj <120", "p");

  
  tight_anal7->GetXaxis()->SetTitle("m_{N} GeV");
  tight_anal7->GetYaxis()->SetTitle("ID efficiency");
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/PreApproval/SignalPlots/Punzi_presel_med_lowmass2.pdf" ));
  return;
