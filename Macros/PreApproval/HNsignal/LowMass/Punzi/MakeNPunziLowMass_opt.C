...
void MakeNPunziLowMass_opt(){
  ...
  tight_anala->SetMarkerColor(kRed);
  tight_anala->SetMarkerStyle(20.);
  tight_analb->SetMarkerColor(kRed);
  tight_analb->SetMarkerStyle(21.);
  tight_analc->SetMarkerColor(kRed);
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/PreApproval/SignalPlots/Punzi_presel_med_lowmass.pdf" ));
  return;
