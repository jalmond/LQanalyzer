...
void MakeNsignalEff_noZ(){
  
  setTDRStyle();
  gStyle->SetPalette(1);


  TH1* medium = makehist("PreSelection_medium_noZ");
  TH1* tight = makehist("PreSelection_tight_noZ");
  TH1* susy = makehist("PreSelection_susy_noZ");
  TH1* tight_dxy10 = makehist("PreSelection_iso_10_10_noZ");
  TH1* tight_anal = makehist("PreSelection_noZ");
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/PreApproval/SignalPlots/SignalEff_presel_med_tight_noZ.pdf" ));
}
