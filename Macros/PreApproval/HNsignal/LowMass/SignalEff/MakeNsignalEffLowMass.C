...
void MakeNsignalEffLowMass(){
  ...
  TH1F* tight_anal1 = makehist("PreSelection_noZ");
  TH1F* tight_anal3 = makehist("PreSelection_met");
  TH1F* tight_anal4 = makehist("PreSelection_bjet");
  TH1F* tight_anal5 = makehist("PreSelection_jj");
  TH1F* tight_anal8 = makehist("PreSelection_lowmass");
  ...
  tight_anal8->SetMarkerStyle(27.);

  legendH->AddEntry(tight_anal1, "Preselection", "p");
  legendH->AddEntry(tight_anal3, "MET", "p");
  legendH->AddEntry(tight_anal4, "bjet veto", "p");
  legendH->AddEntry(tight_anal5, "m(jj) cut", "p");
  legendH->AddEntry(tight_anal8, "m(eejj) cut", "p");
  ...
  TH1* ratio_lowmass_presel = tight_anal8->Clone("ratio");

  ratio_lowmass_presel->Divide(tight_anal1);
  ratio_lowmass_presel->GetYaxis()->SetTitle("Ratio");
  ratio_lowmass_presel->SetLineColor(kRed);
  ratio_lowmass_presel->Draw("hist");


  c1->SaveAs(("/home/jalmond/WebPlots/PreApproval/SignalPlots/SignalEff_presel_ratio_lowmass.pdf" ));
