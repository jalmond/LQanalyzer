...
void MakeNsignalEfflowmass(){
  ...
  TH1* lowmass = makehist("LowMassRegion/h_Nelectrons_LowMassRegion");
  ...
  lowmass->GetXaxis()->SetTitle("m_{N} GeV");
  lowmass->GetYaxis()->SetTitle("ID efficiency");
  
  lowmass->SetMarkerColor(kRed);
  
  lowmass->SetMarkerStyle(20.);

  legendH->AddEntry(lowmass, "Tight ID", "p");
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/PreApproval/SignalPlots/SignalEff_lowmass.pdf" ));
}
...
TH1* makehist(TString hist){
  ...
  heff->SetBinContent(1, (hn_40->GetBinContent(3)/href_40->GetBinContent(2)));
  heff->SetBinContent(2, (hn_50->GetBinContent(3)/href_50->GetBinContent(2)));
  heff->SetBinContent(3, (hn_60->GetBinContent(3)/href_60->GetBinContent(2)));
  heff->SetBinContent(4, (hn_70->GetBinContent(3)/href_70->GetBinContent(2)));
  heff->SetBinContent(5, (hn_80->GetBinContent(3)/href_80->GetBinContent(2)));
  /*heff->SetBinContent(6, (hn_90->GetBinContent(3)/href_90->GetBinContent(2)));
  heff->SetBinContent(7, (hn_100->GetBinContent(3)/href_100->GetBinContent(2)));
  heff->SetBinContent(8, (hn_200->GetBinContent(3)/href_200->GetBinContent(2)));
  heff->SetBinContent(9, (hn_300->GetBinContent(3)/href_300->GetBinContent(2)));
  heff->SetBinContent(10, (hn_500->GetBinContent(3)/href_500->GetBinContent(2)));*/
...
TH1* makeRefHist(TString m){
  ...
  TFile* file = new TFile(path);
  TH1* h = (TH1*)file->Get("Efficiency/_eff_electronRef");
  return h;
}
