...
void MakeNSigEffLowMass_id(){
  ...
  tight_anal4->GetYaxis()->SetRangeUser(0.001, 0.01);
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/PreApproval/SignalPlots/SigEff_presel_id_lowmass.pdf" ));
  return;
