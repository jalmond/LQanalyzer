  ...
  */
  ...
  for(mit = mapcut.begin(); mit!= mapcut.end() ; mit++){
    for(unsigned int j=0; j < type.size(); j++){
      ...
      Int_t result []     = {8   , 8 , 8  , 8,18,15,12,9,5,3,2,2,2,2,2};
      Double_t mass[]     = {40 , 50, 60,  80   , 90    , 100   , 125   , 150   , 175    , 200  ,  250 ,   300     , 350    , 400     , 500 };
      Double_t k_factor=1.;
      Double_t xsec_alp[] = {1516, 1071.1, 607.7, 19.07, 7.1047, 3.5618, 1.0767, 0.4594, 0.23266, 0.13127,  0.050928,  0.023214,  0.011705, 0.006332, 0.002154};
