...
void fixOverlay();
void setTDRStyle();
TCanvas* CompDataMC(TH1* hdata, TH1* hsig1, TH1* hsig2, TH1* hsig3, vector<THStack*> mcstack,TH1* hup, TH1* hdown,TLegend* legend, const string hname, const int rebin, double xmin, double xmax,double ymin, double ymax,string path , string folder, bool logy, bool usedata, TString channel);
