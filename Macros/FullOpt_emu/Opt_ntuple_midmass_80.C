...
void Opt_ntuple_midmass_80(){
  ...
  f_chainsig->Add("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectronMuon_opt/HNEMu_SKHNmue80_nocut_5_3_14.root");
  f_chainsig->Add("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectronMuon_opt/HNEMu_SKHNemu80_nocut_5_3_14.root");
  TFile * file1 = new TFile("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectronMuon_opt/HNEMu_SKHNmue80_nocut_5_3_14.root");
  TFile * file2 = new TFile("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectronMuon_opt/HNEMu_SKHNemu80_nocut_5_3_14.root");
  ...
  for(unsigned int imet=0; imet < METcut.size(); imet++){
    ...
    for(int imemujjmin= 0; imemujjmin < iemujj_min_k; imemujjmin++){
      float memujjmin_cut = 90. + float(imemujjmin) * 10.;
      for(int imemujjmax= 0; imemujjmax <iemujj_max_k ; imemujjmax++){
	float memujjmax_cut = 180.+ float(imemujjmax)*5.;
