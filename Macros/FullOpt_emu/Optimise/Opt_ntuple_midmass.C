...
void Opt_ntuple_midmass(){
  ...
  for(int imass =0; imass < masses.size(); imass++){
    ...
    f_chainsig->Add(("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectron_ntup/HNDiElectron_SKHNee" + masses.at(imass) + "_nocut_5_3_14.root").Data());
    TFile * file = new TFile(("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectron_ntup/HNDiElectron_SKHNee" + masses.at(imass) + "_nocut_5_3_14.root").Data());
    cout << file << endl;
		  ...
		  for(int ie1jjmin =0 ; ie1jjmin < 1 ; ie1jjmin++){
			...
			for(int ie2jjmax =0 ; ie2jjmax < 1 ; ie2jjmax++){
			  ...
			  for(int ihtmin =0 ; ihtmin < 1 ; ihtmin++){
			    ...
			    for(int ihtmax =0 ; ihtmax < 1; ihtmax++){
    ...
    cout << "Masses = " << masses.at(imass) << endl;
