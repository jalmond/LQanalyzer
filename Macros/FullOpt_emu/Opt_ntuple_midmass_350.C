...
void Opt_ntuple_midmass_350(){
  ...
  f_chainsig->Add("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectronMuon/HNEMu_SKHNmue350_nocut_5_3_14.root");
  f_chainsig->Add("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectronMuon/HNEMu_SKHNemu350_nocut_5_3_14.root");
  TFile * file1 = new TFile("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectronMuon/HNEMu_SKHNmue350_nocut_5_3_14.root");
  TFile * file2 = new TFile("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectronMuon/HNEMu_SKHNemu350_nocut_5_3_14.root");
  ...
  for(unsigned int imet=0; imet < METcut.size(); imet++){
    ...
    for(int imemujjmin= 0; imemujjmin < iemujj_min_k ; imemujjmin++){
      float memujjmin_cut = 300. + float(imemujjmin) * 10.;
