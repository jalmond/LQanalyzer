...
void Opt_ntuple_midmass_90l(){
  ...
  for(unsigned int imet=0; imet < METcut.size(); imet++){
    ...
    for(int imeejjmin= 0; imeejjmin < 1 ; imeejjmin++){
      ...
      for(int imeejjmax= 0; imeejjmax <3. ; imeejjmax++){
	float meejjmax_cut = 210.+ float(imeejjmax)*20.;
	...
	for(int ipt1= 0; ipt1 <1. ; ipt1++){
	  ...
	  for(int ipt2= 0; ipt2 < 1. ; ipt2++){
		...
		for(int ieemax =0 ; ieemax <1 ; ieemax++){
		  float eemax_cut =  100000. + float(ieemax) * 5. ;
		  if(ieemax == 3) eemax_cut = 100000.;
		  cout << eemin_cut << " <  ee < " <<   eemax_cut << endl;
		  
		  for(int ie1jjmin =0 ; ie1jjmin < 4 ; ie1jjmin++){
                  float e1jjmin_cut = 60. + float(ie1jjmin)* 10.;

                  for(int ie1jjmax =0 ; ie1jjmax < 8 ; ie1jjmax++){
                    float e1jjmax_cut =  120. + float(ie1jjmax)* 10.;

		    for(int ie2jjmin =0 ; ie2jjmin < 3 ; ie2jjmin++){
		      float e2jjmin_cut = 70. + float(ie2jjmin)* 10.;
		      
		      for(int ie2jjmax =0 ; ie2jjmax < 4 ; ie2jjmax++){
