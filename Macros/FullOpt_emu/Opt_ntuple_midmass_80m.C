...
void Opt_ntuple_midmass_80m(){
  ...
  f_chainsig->Add("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectron_ntup/HNDiElectron_basic_SKHNee80_nocut_5_3_14.root");
  TFile * file = new TFile("/home/jalmond/Analysis/LQanalyzer/data/output/SSElectron_ntup/HNDiElectron_basic_SKHNee80_nocut_5_3_14.root");
  cout << file << endl;
		...
		for(int ieemax =0 ; ieemax <1 ; ieemax++){
		  ...
		  for(int ie1jjmin =0 ; ie1jjmin < 1 ; ie1jjmin++){
			...
			for(int ie2jjmax =0; ie2jjmax < 5 ; ie2jjmax++){
			  float e2jjmax_cut =  1000000. + float(ie2jjmax)* 5.;
