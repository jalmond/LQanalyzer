...
void Opt_id_select(){
  ...
  TH1F* h_npcutflow= (TH1F*)fnp->Get(("LowIDREFSNUTight_double"));
  TH1F* h_mccutflow= (TH1F*)fmc->Get(("LowIDREFSNUTight_double"));

  TH1F* h_datacutflow= (TH1F*)fdata->Get(("LowIDREFSNUTight_double"));
  ...
  for(unsigned int im=0; im < masses.size(); im++){
    ...
    TH1F* h_cutflow= (TH1F*)fsig->Get(("LowIDREFSNUTight_double"));
    TH1F* h_cutflow2= (TH1F*)fsig2->Get(("LowIDREFSNUTight_double"));
