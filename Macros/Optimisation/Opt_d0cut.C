...
void Opt_d0cut(){
  ...
  TH1F* h_npcutflow= (TH1F*)fnp->Get(("d0cutflowzoomed"));
  TH1F* h_cfcutflow= (TH1F*)fcf->Get(("d0cutflowzoomed"));
  TH1F* h_mccutflow= (TH1F*)fmc->Get(("d0cutflowzoomed"));
  ...
  for(unsigned int im=0; im < masses.size(); im++){
    ...
    TH1F* h_cutflowref= (TH1F*)fsig->Get(("d0cutflow"));
    TH1F* h_cutflowref2= (TH1F*)fsig2->Get(("d0cutflow"));
