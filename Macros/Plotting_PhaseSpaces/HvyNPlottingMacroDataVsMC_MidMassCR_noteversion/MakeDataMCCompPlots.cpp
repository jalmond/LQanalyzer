...
void SetTitles(TH1* hist, string name){
  ...
  if(name.find("eemass")!=string::npos)xtitle="e^{#pm}e^{#pm} invariant mass (GeV/c^{2})";
  ...
  if(name.find("e2jjmass")!=string::npos)xtitle="e_{2}jj invariant mass (GeV/^{2})";
  if(name.find("eejjmass")!=string::npos)xtitle="e^{#pm}e^{#pm}jj (GeV/c^{2})";
