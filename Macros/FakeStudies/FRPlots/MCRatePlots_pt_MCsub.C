...
void FR_pt(){
  ...
  setTDRStyle();
  TString cut="pt";
  TH1D* h = MakeFRPlot("GENT","_eb1_","ptcorr1D_full",false);
  TH1D* h2 = MakeFRPlot("GENT","_eb2_","ptcorr1D_full",false);
  TH1D* h3 = MakeFRPlot("GENT","_ee_","ptcorr1D_full",false);

  TH1D* ht = MakeFRPlot("GENT","_eb1_","ptcorr1D_full",true);
  TH1D* ht2 = MakeFRPlot("GENT","_eb2_","ptcorr1D_full",true);
  TH1D* ht3 = MakeFRPlot("GENT","_ee_","ptcorr1D_full",true);
  ...
  legend->AddEntry(h,"GENT EB1","l");
  legend->AddEntry(ht,"GENT EB1(top)","l");
