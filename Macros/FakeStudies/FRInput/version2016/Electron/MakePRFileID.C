...
void MakePRRootFile(){
  ...
  TString denom ="Prompt_LooseEl_ELECTRON_HN_TIGHTv4_HN_TIGHT_pt_eta";
  TString num ="Prompt_TightEl_ELECTRON_HN_TIGHTv4_HN_TIGHT_pt_eta";
  ...
  TString name = "_pt_eta";
  
  TH2D* eff_rate = (TH2D*)h_pt_num->Clone(("PromptRate_ELECTRON_HN_TIGHTv4"));
