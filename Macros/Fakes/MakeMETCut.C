...
void MakeMTCut(TString path) {
  ...
  /// Make MTelectron_SingleLooseElJet plot
  TH1F* h_data= (TH1F*)fdata->Get(("SingleLooseElJet/h_MET_SingleLooseElJet"));

  TH1F* h_mc= (TH1F*)fmc->Get(("SingleLooseElJet/h_MET_SingleLooseElJet"));
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/Fakes/MET_loosesample.pdf"));
