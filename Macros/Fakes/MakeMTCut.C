...
void MakeMTCut(TString path) {
  ...
  TH1F* h_data= (TH1F*)fdata->Get(("SingleTightElJet_tm/h_MTelectron_SingleTightElJet_tm"));

  TH1F* h_mc= (TH1F*)fmc->Get(("SingleTightElJet_tm/h_MTelectron_SingleTightElJet_tm"));
  ...
  h_ratio->GetYaxis()->SetRangeUser(0.0,25.0);
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/Fakes/MT_Tightsample.pdf"));
