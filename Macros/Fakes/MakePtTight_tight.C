...
void MakePtTight(TString path) {
  ...
  TH1F* h_data= (TH1F*)fdata->Get(("SingleTightElJet_tm/h_leadingElectronPt_SingleTightElJet_tm"));

  TH1F* h_mc= (TH1F*)fmc->Get(("SingleTightElJet_tm/h_leadingElectronPt_SingleTightElJet_tm"));
  ...
  c1->SaveAs(("/home/jalmond/WebPlots/Fakes/PT_tightsample.pdf"));
