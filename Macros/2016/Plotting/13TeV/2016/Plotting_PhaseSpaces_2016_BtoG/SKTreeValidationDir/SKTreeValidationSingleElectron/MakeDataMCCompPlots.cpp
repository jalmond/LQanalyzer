...
vector<pair<TString,float> >  InitSample (TString sample){
  ...
  if(sample.Contains("dy_")){
    //list.push_back(make_pair("DY10to50_MCatNLO",0.2));
    //list.push_back(make_pair("DY50plus_MCatNLO",0.2));
    list.push_back(make_pair("DY10to50_MadGraph",0.2));
  ...
  if(sample.Contains("qcd"))
    {
      list.push_back(make_pair("QCD_20to30_bcToE_pythia8",0.30));
      list.push_back(make_pair("QCD_30to80_bcToE_pythia8",0.30));
      list.push_back(make_pair("QCD_80to170_bcToE_pythia8",0.30));
      list.push_back(make_pair("QCD_170to250_bcToE_pythia8",0.30));
      list.push_back(make_pair("QCD_250toInf_bcToE_pythia8",0.30));
      list.push_back(make_pair("QCD_em20to30_pythia8",0.30));
      list.push_back(make_pair("QCD_em50to80_pythia8",0.30));
      list.push_back(make_pair("QCD_em80to120_pythia8",0.30));
      list.push_back(make_pair("QCD_em120to170_pythia8",0.30));
      list.push_back(make_pair("QCD_em170to300_pythia8",0.30));
      list.push_back(make_pair("QCD_em300toINF_pythia8",0.30));
    }
  ...
  if(sample.Contains("nonprompt_SingleElectron")){
    list.push_back(make_pair("nonprompt_SingleElectron",0.34));
  }
...
THStack* MakeStack(vector<pair<pair<vector<pair<TString,float> >, int >, TString > > sample, TString type, string name, float xmin, float xmax,map<TString, TH1*>& legmap , int rebin, bool include_syst_err){
  ...
  for(vector<pair<pair<vector<pair<TString,float> >, int >, TString > >::iterator it = sample.begin() ; it!= sample.end(); it++){
    ...
    if(!type.Contains("Nominal")) {
      if(it->first.first.at(0).first.Contains("nonprompt_SingleElectron"))fileloc=mcloc;
    }    
...
void  SetUpConfig(vector<pair<pair<vector<pair<TString,float> >, int >, TString > >& samples, vector<pair<pair<vector<pair<TString,float> >, int >, TString > >& samples_ss, vector<string>& cut_label){
  ...
  np.push_back(make_pair("nonprompt_SingleElectron",0.34));
  ...
  for( unsigned int i = 0; i < listofsamples.size(); i++){
    ...
    if(listofsamples.at(i) =="nonprompt_SingleElectron")samples.push_back(make_pair(make_pair(np,fcol),"Misid. Lepton Background"));   
  ...
  for( unsigned int i = 0; i < listofsamples_ss.size(); i++){
    ...
    if(listofsamples_ss.at(i) =="nonprompt_SingleElectron")samples_ss.push_back(make_pair(make_pair(np,fcol),"Misid. Lepton Background"));
