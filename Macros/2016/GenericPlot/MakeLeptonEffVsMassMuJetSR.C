...
void MakeLeptonEffVsMassMuJet(){
  ...
  for( mit = masslist.begin(); mit !=masslist.end(); mit++,i++){
    ...
    */
    ...
    float n_jet= hS1->GetBinContent(12);
    float n_jet1= hS1->GetBinContent(13);
    float n_jet2= hS1->GetBinContent(14);
    float n_jet3= hS1->GetBinContent(15);

    float n_lm= hS1->GetBinContent(18);
    float n_hm= hS1->GetBinContent(20);
    ...
    //jet = n_jet1 ;
    float lm = 0.;
    if(i < 6)lm = hS1->GetBinContent(18) + hS1->GetBinContent(19);
    else lm = hS1->GetBinContent(18) ;
    float hm = 0.;
    if(i < 6)hm = hS1->GetBinContent(20);
    else hm = hS1->GetBinContent(20) + hS1->GetBinContent(21);

    h2a->SetBinContent(i,n_jet1/n_nocut);
    h2->SetBinContent(i,jet/n_nocut);
    
    h3->SetBinContent(i,lm/n_nocut);
    h4->SetBinContent(i,hm/n_nocut);
  ...
  for( mit = masslistT.begin(); mit !=masslistT.end(); mit++,i++){
    ...
    bool norm=true;
    int rb=1;
    cout << path+"/"+analyzer+"_HNDilepton_MuMu_Tchannel_M"+mit->second+"_cat_v8-0-7.root" << endl;
    TH1F* hS1 = MakePlot(analyzer,date,"_HNDilepton_MuMu_Tchannel_M"+mit->second+"_cat",dirname+histname,norm, fmc_,rb);

    float n_nocut = hS1->GetBinContent(1);
    float n_lep= hS1->GetBinContent(11);
    float n_jet= hS1->GetBinContent(12);
    float n_lm= hS1->GetBinContent(17);
    float n_hm= hS1->GetBinContent(17);

    h1->SetBinContent(i,n_lep/n_nocut);
    h2->SetBinContent(i,n_jet/n_nocut);
    h3->SetBinContent(i,n_lm/n_nocut);
    h4->SetBinContent(i,n_hm/n_nocut);
  ...
  TLegend *legend = new TLegend(.2, 0.75, .5, 0.9);
  legend->SetFillColor(10);
  legend->SetBorderSize(0);
  legend->SetTextSize(0.03);
  legend->AddEntry(h1,"SS2l","l");
  legend->AddEntry(h2a,"SS2l+2j","l");
  legend->AddEntry(h2,"SS2l+j","l");
  legend->AddEntry(h3,"low-mass SR","l");
  legend->AddEntry(h4,"high-mass SR","l");
