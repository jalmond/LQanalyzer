...
void MakeLeptonEffVsMass8TeV(){
  ...
  for( mit = masslist.begin(); mit !=masslist.end(); mit++,i++){
    ...
    */
    ...
    float n_lep13= hS1->GetBinContent(11); 
    float n_lep8= hS1->GetBinContent(23); 

    


    h1->SetBinContent(i,n_lep13/n_nocut);
    h3->SetBinContent(i,n_lep8/n_nocut);
  ...
  TLegend *legend = new TLegend(.2, 0.2, .5, 0.4);
  legend->SetFillColor(10);
  legend->SetBorderSize(0);
  legend->SetTextSize(0.03);
  legend->AddEntry(h1,"13 TeV SS2l","l");
  legend->AddEntry(h3,"8 TeV SS2l","l");
  ...
  legend->Draw();
  c1->SaveAs(histname+"_8TeVeff.pdf");
    
  gSystem->Exec("scp "+histname+"_8TeVeff.pdf jalmond@lxplus022.cern.ch:~/www/SignalHN/");
  
  cout << "~/www/SignalHN/"+histname+"_8TeVeff.pdf" << endl;
}
