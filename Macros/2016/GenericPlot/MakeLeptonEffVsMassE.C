...
void MakeLeptonEffVsMassE(){
  ...
  for( mit = masslist.begin(); mit !=masslist.end(); mit++,i++){
    ...
    */
    ...
    h3->SetBinContent(i,n_dxy/n_pt);
    h4->SetBinContent(i,n_dz/n_dxy);
    h5->SetBinContent(i,n_charge/n_dz);
    h6->SetBinContent(i,n_conv/n_charge);
    h7->SetBinContent(i,n_iso/n_dxysig);
    h8->SetBinContent(i,n_mva/n_iso);
    h9->SetBinContent(i,n_pogmva/n_iso);
