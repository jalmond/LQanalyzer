...
void MakeWZmassSS(float maxmass, TString mass){
  ...
  TString histname2 = "DiMuon_inclusiveTruth_WZ_Zmass";
  ...
  TFile * fmc_2= new TFile( (path+"/"+analyzer+"_SKWZTo3LNu_amcatnlo_cat_v8-0-7.root" ).Data());
  TFile * fmc_3= new TFile( (path+"/"+analyzer+"_SKWZTo3LNu_mllmin01_cat_v8-0-7.root" ).Data());
  
  TString dirname = "Hists/";
  bool norm=false;
  int rb=2;
  TH1F* hS1 = MakePlot(analyzer,date,"WZTo3LNu_powheg_cat",dirname+histname,norm, fmc_1,rb); 
  ...
  TH1F* hS12 = MakePlot(analyzer,date,"WZTo3LNu_powheg_cat",dirname+histname2,norm, fmc_1,rb);
  TH1F* hS22 = MakePlot(analyzer,date,"WZTo3LNu_amcatnlo_cat",dirname+histname2,norm, fmc_2,rb);
  ...
  hS3->SetLineWidth(2.);
    ...
    legend->AddEntry(hS1,"WZ powheg *0.97","l");
    ...
    c1->SaveAs("WZ/" + histname+"_"+mass+"_ss_all.pdf","pdf"); 
    
    
    gSystem->Exec("scp WZ/" + histname+"_"+mass+"_ss_all.pdf  jalmond@lxplus102.cern.ch:~/www/2016AN/");
    
    cout << "https://jalmond.web.cern.ch/jalmond/2016AN/"+histname+"_"+mass+"_ss_all.pdf" << endl;
