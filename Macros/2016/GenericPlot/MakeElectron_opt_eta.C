...
void MakeElectron_opt_eta(){
  ...
  TFile * fmc_s_40 = new TFile( (path+"/"+analyzer+"_HNEpEp_40_cat_v8-0-7.root" ).Data());
  ...
  bool norm=true;
  int rb=1;
  TH1F* hS = MakePlot(analyzer,date,"HNEpEp_40_cat","Hists/"+hist,norm, fmc_s_40,rb); 
  TH1F* hS2 = MakePlot(analyzer,date,"HNEpEp_200_cat","Hists/"+hist,norm, fmc_s_200,rb); 
  TH1F* hS3 = MakePlot(analyzer,date,"HNEpEp_1000_cat","Hists/"+hist,norm, fmc_s_1000,rb); 
  ...
  legendS->AddEntry(hS,"MVA(80%) WN->ee m_{N}(40)","l");
  legendS->AddEntry(hS2,"MVA(80%) WN->ee m_{N}(200)","l");
  legendS->AddEntry(hS3,"MVA(80%)  WN->ee m_{N}(1000)","l");
