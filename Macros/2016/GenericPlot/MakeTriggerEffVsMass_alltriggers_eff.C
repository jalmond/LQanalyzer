...
void MakeTriggerEffVsMass_alltriggers_eff(TString ptcut){
  ...
  for( mit = masslist.begin(); mit !=masslist.end(); mit++,i++){
    ...
    h1->SetBinContent(i+1, hS1->GetBinContent(3));
    h2->SetBinContent(i+1, hS1->GetBinContent(9));
    h3->SetBinContent(i+1, hS1->GetBinContent(15));
    h4->SetBinContent(i+1,  hS1->GetBinContent(9) /  hS1->GetBinContent(3));
    h5->SetBinContent(i+1,  hS1->GetBinContent(15) /  hS1->GetBinContent(3));
  ...
  h4->GetXaxis()->SetTitle("ratio (eff)");
  ...
  lg_ratio->AddEntry(h4,"OR Mu50","l");
  lg_ratio->AddEntry(h5,"OR Iso24","l");
  lg_ratio->Draw();
  ...
  legend->AddEntry(h1,"Mu17Mu8","p");
  legend->AddEntry(h2,"Mu17Mu8||Mu50","p");
  legend->AddEntry(h3,"Mu17Mu8||Mu24","p");


  legend->Draw();

  c1->SaveAs("HNDiLeptonHighMass/Trigger_muonor_all_"+ptcut+"muon.pdf","pdf");
    
  gSystem->Exec("scp HNDiLeptonHighMass/Trigger_muonor_all_"+ptcut+"muon.pdf jalmond@lxplus102.cern.ch:~/www/SignalHN/HighMass/");
  
  cout << "~/www/SignalHN/HighMass/Trigger_muonor_all_"+ptcut+"muon.pdf" << endl;
}
