...
float CoutEff(TH1F* h){
  ...
  int bin1 = h->FindBin(-0.01);
  int bin2 = h->FindBin(0.01);
...
void IsoElectrons(TString path){
  ...
  if(1){
    TH1F* hz_ss_conv = MakeHist(path,"SSMatched_conv_dxy");
    TH1F* hz_ss_tau = MakeHist(path,"SSMatched_tau_dxy");
    TH1F* hz_ss_cftau = MakeHist(path,"SSMatched_cftau_dxy");
    TH1F* hz_ss_x  =MakeHist(path,"SSMatched_x_dxy");
    TH1F* h =MakeHist(path,"ZMatched_dxy");
    TH1F * h_m_wz = MakeHist(path,"Matched_W_Z_dxy");
    TH1F * h_m_cf = MakeHist(path,"Matched_CF_dxy");
    TH1F * h_m_cfconv = MakeHist(path,"Matched_CF_conv_dxy");
    TH1F * h_m_cfnotconv = MakeHist(path,"Matched_CF_notconv_dxy");
    TH1F * h_m_notcf= MakeHist(path,"Matched_noCF_dxy");
    TH1F * h_m_conv=  MakeHist(path,"Matched_CONV_dxy");
    TH1F * h_m_convnocf =  MakeHist(path,"Matched_CONV_notCF_dxy");
    TH1F * h_m_noconv=  MakeHist(path,"Matched_noCONV_dxy");
    TH1F * h_m_tau=   MakeHist(path,"Matched_TAUD_dxy");
    TH1F * h_m_notau=   MakeHist(path,"Matched_noTAUD_dxy");
    TH1F * h_m_ph=   MakeHist(path,"Matched_PH_dxy");

    TH1F * h_nm_cf = MakeHist(path,"NonMatched_CF_dxy");
    TH1F * h_nm_cfconv = MakeHist(path,"NonMatched_CF_conv_dxy");
    TH1F * h_nm_cfnotconv = MakeHist(path,"NonMatched_CF_notconv_dxy");
    TH1F * h_nm_notcf= MakeHist(path,"NonMatched_noCF_dxy");
    TH1F * h_nm_conv=  MakeHist(path,"NonMatched_CONV_dxy");
    TH1F * h_nm_convnocf =  MakeHist(path,"NonMatched_CONV_notCF_dxy");
    TH1F * h_nm_noconv=  MakeHist(path,"NonMatched_noCONV_dxy");
    TH1F * h_nm_tau=   MakeHist(path,"NonMatched_TAUD_dxy");
    TH1F * h_nm_notau=   MakeHist(path,"NonMatched_noTAUD_dxy");
    TH1F * h_nm_ph=   MakeHist(path,"NonMatched_PH_dxy");
    TH1F * h_fake = MakeHist(path,"NonMatched_Fake_dxy");
    TH1F * h_phfake = MakeHist(path,"NonMatched_PHFake_dxy");
    TH1F * h_ccf = MakeHist(path,"NonMatched_CONV_CF_dxy");
    TH1F * h_cncf = MakeHist(path,"NonMatched_CONV_NONECF_dxy");
