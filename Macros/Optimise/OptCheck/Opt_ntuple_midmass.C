...
void Opt_ntuple_midmass(){
  ...
  for(unsigned int imet=0; imet < METcut.size(); imet++){
    ...
    for(int imeejjmin= 10; imeejjmin < 40. ; imeejjmin++){
  ...
  cout << "Opt cut : " << ime2jjmin_opt << " < M(e2jj) <  " << ime2jjmax_opt << endl;
